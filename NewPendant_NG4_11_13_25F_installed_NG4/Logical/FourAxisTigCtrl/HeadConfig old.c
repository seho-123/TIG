		...
		for(i = 0 ; i < TML_SERVO_NUM ; i++){
			...
			switch(i){
				...
				case TML_AX_TVL:			
					...
					strcpy(TML_MTR_INST[i]._cfg.programName , "2301_CLMSH_TVL.sw");											
					TML_MTR_INST[i].ProgramVersion = ASC2UDINT("2301");
				...
				case TML_AX_OSC:
					...
					strcpy(TML_MTR_INST[i]._cfg.programName , "2302_CLMSH_OSC.sw");
					TML_MTR_INST[i].ProgramVersion = ASC2UDINT("2302");
				...
				case TML_AX_AVC2:	
					...
					//U_BEND_HP_PINS
					strcpy(TML_MTR_INST[i]._cfg.programName , "2303_CLMSH_AVC.sw");
					TML_MTR_INST[i].ProgramVersion = ASC2UDINT("2303");							
				...
				case TML_AX_WF_1: //TML_AX_WRST:
					...
					strcpy(TML_MTR_INST[i]._cfg.programName , "2307_CLMSH_WRST.sw");
					TML_MTR_INST[i].ProgramVersion = ASC2UDINT("2307");
				...
				case TML_AX_WF:
					...
					strcpy(TML_MTR_INST[i]._cfg.programName , "2305_CLMSH_WF.sw");
					TML_MTR_INST[i].ProgramVersion = ASC2UDINT("2305");
				...
				case TML_AX_WP:
					...
					*/
					...
					strcpy(TML_MTR_INST[i]._cfg.programName , "2306_CLMSH_WP.sw");
					TML_MTR_INST[i].ProgramVersion = ASC2UDINT("2306");
