...
PANEL_HW_SOURCE_Visu1=C:/projects/UnivCntrl_NewPendant/UnivCntrl_NewPendant/Physical/X20CP1585_MIG/Hardware.hw 
DIS_OBJECTS_Visu1=$(PANEL_HW_OBJECT_Visu1) $(KEYMAP_OBJECTS_Visu1)

# KeyMapping flags
$(TEMP_PATH_Visu1)/dis.PS2-Keyboard.vco: $(AS_PROJECT_PATH)/Physical/X20CP1585_MIG/PLC1/VC/PS2-Keyboard.dis $(PANEL_HW_SOURCE_Visu1)
	$(VCHWPP) -f '$(PANEL_HW_SOURCE_Visu1)' -o '$(subst .vco,.vci,$(TEMP_PATH_Visu1)/dis.PS2-Keyboard.vco)' -n Visu1 -d Visu1 -pal '$(PALFILE_Visu1)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'E4.26' -L 'AsRfbExt: V*, Visapi: V*' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu1) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard '$(AS_PROJECT_PATH)/Physical/X20CP1585_MIG/PLC1/VC/PS2-Keyboard.dis' -fp '$(AS_VC_PATH)/Firmware/V4.73.1/SG4' -prj '$(AS_PROJECT_PATH)' -apj 'UnivCntrl' -sfas -vcob '$(VCOBJECT_Visu1)'
...
KEYMAP_SOURCES_Visu1=$(AS_PROJECT_PATH)/Physical/X20CP1585_MIG/PLC1/VC/PS2-Keyboard.dis 
...
CLM_SOURCES_Visu1=$(AS_PROJECT_PATH)/Logical/Visu1/ColorMaps/Input_Style.clm \
	...
	$(AS_PROJECT_PATH)/Logical/Visu1/ColorMaps/TimeField.clm 
...
$(TEMP_PATH_Visu1)/tpr.NumPad.vco: $(AS_PROJECT_PATH)/Logical/Visu1/TouchPads/NumPad.tpr
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1) -prj 'C:/projects/UnivCntrl_NewPendant/UnivCntrl_NewPendant/Logical/Visu1' -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4731 -sfas
...
$(TEMP_PATH_Visu1)/clm.TimeField.vco: $(AS_PROJECT_PATH)/Logical/Visu1/ColorMaps/TimeField.clm
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4731 -sfas
