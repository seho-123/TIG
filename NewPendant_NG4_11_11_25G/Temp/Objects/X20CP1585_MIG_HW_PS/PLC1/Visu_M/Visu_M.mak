...
# KeyMapping flags
$(TEMP_PATH_Visu_M)/dis.PS2-Keyboard1.vco: $(AS_PROJECT_PATH)/Physical/X20CP1585_MIG_HW_PS/PLC1/VC/PS2-Keyboard1.dis $(PANEL_HW_SOURCE_Visu_M)
	$(VCHWPP) -f '$(PANEL_HW_SOURCE_Visu_M)' -o '$(subst .vco,.vci,$(TEMP_PATH_Visu_M)/dis.PS2-Keyboard1.vco)' -n Visu_M -d Visu_M -pal '$(PALFILE_Visu_M)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'J4.93' -L 'AsRfbExt: V*, Visapi: V*' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu_M) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard '$(AS_PROJECT_PATH)/Physical/X20CP1585_MIG_HW_PS/PLC1/VC/PS2-Keyboard1.dis' -fp '$(AS_VC_PATH)/Firmware/V4.73.1/SG4' -prj '$(AS_PROJECT_PATH)' -apj 'UnivCntrl' -sfas -vcob '$(VCOBJECT_Visu_M)'
...
KEYMAP_SOURCES_Visu_M=$(AS_PROJECT_PATH)/Physical/X20CP1585_MIG_HW_PS/PLC1/VC/PS2-Keyboard1.dis 
KEYMAP_OBJECTS_Visu_M=$(TEMP_PATH_Visu_M)/dis.PS2-Keyboard1.vco 
...
vcPostBuild_Visu_M :
	$(VCC) -pb -vcm '$(TEMP_PATH_Visu_M)/MODULEFILES.vcm' -fw '$(VCFIRMWAREPATH)' $(VCCFLAGS_Visu_M) -p Visu_M -vcr 4731 -sfas
