...
<SwConfiguration CpuAddress="SL1" xmlns="http://br-automation.co.at/AS/SwConfiguration">
  ...
  <TaskClass Name="Cyclic#3">
    ...
    <Task Name="HMI_M" Source="FourAxisTigCtrl.HMI_M.prg" Memory="UserROM" Language="ANSIC" Debugging="true" />
  ...
  <TaskClass Name="Cyclic#8">
    ...
    <Task Name="cJSONTest" Source="UDP.cJSON.cJSONTest.prg" Memory="UserROM" Language="ANSIC" AdditionalLibraryDirectories="\Logical\UDP\sscanf2\" AdditionalLibraries="sscanf2-i386" Debugging="true" Disabled="true" />
    <Task Name="udpserv" Source="UDP.paiUDPService.udpserv.prg" Memory="UserROM" Language="ANSIC" Debugging="true" Disabled="true" />
    <Task Name="udpApp" Source="UDP.udpApp.prg" Memory="UserROM" Language="ANSIC" Debugging="true" Disabled="true" />
    <Task Name="udpclient" Source="UDP.paiUDPService.udpclient.prg" Memory="UserROM" Language="ANSIC" Debugging="true" Disabled="true" />
    <Task Name="udpsimonly" Source="UDP.udpsimonly.prg" Memory="UserROM" Language="ANSIC" Debugging="true" Disabled="true" />
  </TaskClass>
  <DataObjects>
  ...
  <VcDataObjects>
    ...
    <VcDataObject Name="Visu_M" Source="Visu_M.dob" Memory="UserROM" Language="Vc" WarningLevel="2" />
  </VcDataObjects>
  <Binaries>
