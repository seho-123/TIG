...
<SwConfiguration CpuAddress="SL1" xmlns="http://br-automation.co.at/AS/SwConfiguration">
  ...
  <TaskClass Name="Cyclic#2">
    ...
    <Task Name="_MotorDriv" Source="HotWire._MotorDriver.prg" Memory="UserROM" Language="ANSIC" Debugging="true" />
  ...
  <TaskClass Name="Cyclic#3">
    ...
    <Task Name="_PowerSupp" Source="HotWire._PowerSupplyDriver.prg" Memory="UserROM" Language="ANSIC" Debugging="true" />
    <Task Name="TML_RLY" Source="Universal.TML_RLY.prg" Memory="UserROM" Language="ANSIC" Debugging="true" />
    <Task Name="_Master" Source="HotWire._Master.prg" Memory="UserROM" Language="ANSIC" Debugging="true" />
  </TaskClass>
  <TaskClass Name="Cyclic#4">
    <Task Name="_Menu" Source="HotWire._Menu.prg" Memory="UserROM" Language="ANSIC" Debugging="true" />
  </TaskClass>
