UnmarkedObjectFolder := C:/Users/ckaczkowski/Documents/Official Release/UnivCntrl-10-19-21F CMT version installed in Oct 2021/UniversalController_10-19-21F/Logical/FourAxisTigCtrl/Main2
MarkedObjectFolder := C:/Users/ckaczkowski/Documents/Official\ Release/UnivCntrl-10-19-21F\ CMT\ version\ installed\ in\ Oct\ 2021/UniversalController_10-19-21F/Logical/FourAxisTigCtrl/Main2

$(AS_CPU_PATH)/Main2.br: \
	$(AS_PROJECT_CPU_PATH)/Cpu.per \
	$(AS_CPU_PATH)/Main2/Main2.ox
	@"$(AS_BIN_PATH)/BR.AS.TaskBuilder.exe" "$(AS_CPU_PATH)/Main2/Main2.ox" -o "$(AS_CPU_PATH)/Main2.br" -v V1.00.0 -f "$(AS_CPU_PATH)/NT.ofs" -offsetLT "$(AS_BINARIES_PATH)/$(AS_CONFIGURATION)/$(AS_PLC)/LT.ofs" -T SG4  -M IA32  -B E4.26 -extMembers -extNames -extConstants -r Cyclic3 -p 5 -s "FourAxisTigCtrl.Main2" -L "Acp10man: V3.15.1, Acp10par: V3.15.1, AsARCfg: V*, AsBrMath: V*, AsIecCon: V*, AsIOTime: V*, AsRfbExt: V*, asstring: V*, AsTCP: V*, AsTime: V*, AsUDP: V*, AsXml: V*, bglibas: V*, brsystem: V*, DataObj: V*, dvframe: V*, Ethernet: V*, FileIO: V*, Library: V*, NcGlobal: V3.15.1, Operator: V*, Runtime: V*, sprintf2: V*, standard: V*, sys_lib: V*, Visapi: V*" -P "$(AS_PROJECT_PATH)" -secret "$(AS_PROJECT_PATH)_br.as.taskbuilder.exe"

$(AS_CPU_PATH)/Main2/Main2.ox: \
	$(AS_CPU_PATH)/Main2/a.out
	@"$(AS_BIN_PATH)/BR.AS.Backend.exe" "$(AS_CPU_PATH)/Main2/a.out" -o "$(AS_CPU_PATH)/Main2/Main2.ox" -T SG4 -r Cyclic3   -G V4.1.2  -secret "$(AS_PROJECT_PATH)_br.as.backend.exe"

$(AS_CPU_PATH)/Main2/a.out: \
	$(AS_CPU_PATH)/Main2/Main2_FourAxisTigCtrl.c.c.o \
	...
	@"$(AS_BIN_PATH)/BR.AS.CCompiler.exe" -link  -O "$(AS_CPU_PATH)//Main2/Main2.out.opt" -secret "$(AS_PROJECT_PATH)_br.as.ccompiler.exe"

$(AS_CPU_PATH)/Main2/Main2_FourAxisTigCtrl.c.c.o: \
	$(AS_PROJECT_PATH)/Logical/FourAxisTigCtrl/Main2/Main2_FourAxisTigCtrl.c.c \
	...
	$(AS_PROJECT_PATH)/Logical/FourAxisTigCtrl/Main2/../HMI_Cntrl.c \
	...
	$(AS_PROJECT_PATH)/Logical/Universal/TML_srv/../../Lib/arclink/NetworkAttribute.h \
	$(AS_PROJECT_PATH)/Logical/Universal/TML_srv/../../Lib/arclink/ArcLinkObject.h \
	$(AS_PROJECT_PATH)/Logical/Universal/TML_srv/../../Lib/arclink/Robot.h \
	$(AS_PROJECT_PATH)/Logical/FourAxisTigCtrl/Main2/../../Lib/WSI_types.h \
	$(AS_PROJECT_PATH)/Logical/Universal/TML_srv/../../lib/Statelib.h \
	...
	$(AS_PROJECT_PATH)/Logical/FourAxisTigCtrl/Main2/../GlobDecl.h \
	...
	$(AS_PROJECT_PATH)/Logical/Universal/TML_srv/../../Lib/arclink/arclink.h \
	...
	$(AS_PROJECT_PATH)/Logical/FourAxisTigCtrl/Hardcoded.c \
	$(AS_PROJECT_PATH)/Logical/Lib/LCDLib.c \
	$(AS_PROJECT_PATH)/Logical/FourAxisTigCtrl/HMI_Cntrl.c \
	$(AS_PROJECT_PATH)/Logical/FourAxisTigCtrl/HeadConfig.c \
	$(AS_PROJECT_PATH)/Logical/Lib/Statelib.c \
	$(AS_PROJECT_PATH)/Logical/lib/WSI_types.h \
	$(AS_PROJECT_PATH)/Logical/lib/statelib.h \
	$(AS_PROJECT_PATH)/Logical/Lib/LoggerLib.c
	@"$(AS_BIN_PATH)/BR.AS.CCompiler.exe" "$(AS_PROJECT_PATH)/Logical/FourAxisTigCtrl/Main2/Main2_FourAxisTigCtrl.c.c" -o "$(AS_CPU_PATH)/Main2/Main2_FourAxisTigCtrl.c.c.o"  -T SG4  -M IA32  -B E4.26 -G V4.1.2  -s "FourAxisTigCtrl.Main2" -t "$(AS_TEMP_PATH)" -I "$(AS_PROJECT_PATH)/Logical/FourAxisTigCtrl/Main2" "$(AS_TEMP_PATH)/Includes/FourAxisTigCtrl/Main2"  "$(AS_TEMP_PATH)/Includes/FourAxisTigCtrl" "$(AS_TEMP_PATH)/Includes" -trigraphs -fno-asm -D _DEFAULT_INCLUDES -D _SG4 -fPIC -O0 -g -Wall -include "$(AS_CPU_PATH)/Libraries.h" -x c -P "$(AS_PROJECT_PATH)" -secret "$(AS_PROJECT_PATH)_br.as.ccompiler.exe"
