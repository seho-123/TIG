...
$(AS_CPU_PATH)/VcFntDat/arial.ccf:$(AS_CPU_PATH)/VcFntDat/arial.vco
	 $(LINK) '$^' -o '$@' -warningLevel2 -m arial.ttf -name Visu_M -profile 'False' -vcr 4732 -sfas
...
$(AS_CPU_PATH)/VcFntDat/arialbd.ccf:$(AS_CPU_PATH)/VcFntDat/arialbd.vco
	 $(LINK) '$^' -o '$@' -warningLevel2 -m arialbd.ttf -name Visu_M -profile 'False' -vcr 4732 -sfas
...
$(AS_CPU_PATH)/VcFntDat/arialbi.ccf:$(AS_CPU_PATH)/VcFntDat/arialbi.vco
	 $(LINK) '$^' -o '$@' -warningLevel2 -m arialbi.ttf -name Visu_M -profile 'False' -vcr 4732 -sfas
