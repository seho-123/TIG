...
PANEL_HW_SOURCE_Visu_M=C:/projects/NG4_TIG/NewPendant_NG4_10_21_25A/Physical/X20CP1585_MIG_HW_PS/Hardware.hw 
DIS_OBJECTS_Visu_M=$(PANEL_HW_OBJECT_Visu_M) $(KEYMAP_OBJECTS_Visu_M)

# KeyMapping flags
$(TEMP_PATH_Visu_M)/dis.PS2-Keyboard.vco: $(AS_PROJECT_PATH)/Physical/X20CP1585_MIG_HW_PS/PLC1/VC/PS2-Keyboard.dis $(PANEL_HW_SOURCE_Visu_M)
	$(VCHWPP) -f '$(PANEL_HW_SOURCE_Visu_M)' -o '$(subst .vco,.vci,$(TEMP_PATH_Visu_M)/dis.PS2-Keyboard.vco)' -n Visu_M -d Visu_M -pal '$(PALFILE_Visu_M)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'J4.93' -L 'AsRfbExt: V*, Visapi: V*' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu_M) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard '$(AS_PROJECT_PATH)/Physical/X20CP1585_MIG_HW_PS/PLC1/VC/PS2-Keyboard.dis' -fp '$(AS_VC_PATH)/Firmware/V4.73.2/SG4' -prj '$(AS_PROJECT_PATH)' -apj 'UnivCntrl' -sfas -vcob '$(VCOBJECT_Visu_M)'
	$(VCC) -f '$(subst .vco,.vci,$@)' -o '$@' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -k '$(VCVK_SOURCES_Visu_M)' $(VCCFLAGS_Visu_M) -p Visu_M -sfas

KEYMAP_SOURCES_Visu_M=$(AS_PROJECT_PATH)/Physical/X20CP1585_MIG_HW_PS/PLC1/VC/PS2-Keyboard.dis 
KEYMAP_OBJECTS_Visu_M=$(TEMP_PATH_Visu_M)/dis.PS2-Keyboard.vco 
...
$(PANEL_HW_VCI_Visu_M): $(PANEL_HW_SOURCE_Visu_M) $(VC_LIBRARY_LIST_Visu_M) $(KEYMAP_SOURCES_Visu_M) $(PALFILE_Visu_M)
	$(VCHWPP) -f '$<' -o '$@' -n Visu_M -d Visu_M -pal '$(PALFILE_Visu_M)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'J4.93' -L 'AsRfbExt: V*, Visapi: V*' -verbose 'False' -profile 'False' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu_M) -sos $(VC_STATIC_OPTIONS_Shared) -fp '$(AS_VC_PATH)/Firmware/V4.73.2/SG4' -sfas -prj '$(AS_PROJECT_PATH)' -apj 'UnivCntrl' -vcob '$(VCOBJECT_Visu_M)'

$(PANEL_HW_OBJECT_Visu_M): $(PANEL_HW_VCI_Visu_M) $(VC_LIBRARY_LIST_Visu_M)
	$(VCC) -f '$(subst .vco,.vci,$@)' -o '$@' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -k '$(VCVK_SOURCES_Visu_M)' $(VCCFLAGS_Visu_M) -p Visu_M -so $(VC_STATIC_OPTIONS_Visu_M) -vcr 4732 -sfas
...
$(TEMP_PATH_Visu_M)/page.p1_RUN.vco: $(AS_PROJECT_PATH)/Logical/Visu_M/Pages/p1_RUN.page $(VC_LANGUAGES_Visu_M)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu_M)' $(VCCFLAGS_Visu_M) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_Visu_M)/StyleSheets/Default.vcs' -p Visu_M -so $(VC_STATIC_OPTIONS_Visu_M) -vcr 4732 -sfas
...
$(TEMP_PATH_Visu_M)/vcs.Default.vco: $(AS_PROJECT_PATH)/Logical/Visu_M/StyleSheets/Default.vcs
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu_M)' $(VCCFLAGS_Visu_M) -P '$(AS_PROJECT_PATH)' -ds $(DEFAULT_STYLE_SHEET_Visu_M) -p Visu_M -so $(VC_STATIC_OPTIONS_Visu_M) -vcr 4732 -sfas
...
$(TEMP_PATH_Visu_M)/layer.globalArea.vco: $(AS_PROJECT_PATH)/Logical/Visu_M/Layers/globalArea.layer $(VC_LANGUAGES_Visu_M)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu_M)' $(VCCFLAGS_Visu_M) -ds $(DEFAULT_STYLE_SHEET_Visu_M) -p Visu_M -so $(VC_STATIC_OPTIONS_Visu_M) -vcr 4732 -sfas
...
$(TEMP_PATH_Visu_M)/tpr.NumPad.vco: $(AS_PROJECT_PATH)/Logical/Visu_M/TouchPads/NumPad.tpr
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu_M)' $(VCCFLAGS_Visu_M) -prj 'C:/projects/NG4_TIG/NewPendant_NG4_10_21_25A/Logical/Visu_M' -p Visu_M -so $(VC_STATIC_OPTIONS_Visu_M) -vcr 4732 -sfas
...
$(VCR_OBJECT_Visu_M) : $(VCR_SOURCE_Visu_M)
	$(VCC) -f '$<' -o '$@' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -sl en $(VCCFLAGS_Visu_M) -rt  -p Visu_M -so $(VC_STATIC_OPTIONS_Visu_M) -vcr 4732 -sfas
...
$(TEMP_PATH_Visu_M)/Visu_M01.ccf: $(LIB_SHARED) $(SHARED_CCF) $(LIB_BMP_RES_Visu_M) $(TEMP_PATH_Visu_M)/Visu_M03.ccf $(LIB_LOCAL_RES_Visu_M) $(TEMP_PATH_Visu_M)/Visu_M02.ccf $(DIS_OBJECTS_Visu_M) $(PAGE_OBJECTS_Visu_M) $(VCS_OBJECTS_Visu_M) $(VCVK_OBJECTS_Visu_M) $(VCRT_OBJECTS_Visu_M) $(TPR_OBJECTS_Visu_M) $(TXTGRP_OBJECTS_Visu_M) $(LAYER_OBJECTS_Visu_M) $(VCR_OBJECT_Visu_M) $(TDC_OBJECTS_Visu_M) $(TRD_OBJECTS_Visu_M) $(TRE_OBJECTS_Visu_M) $(PRC_OBJECTS_Visu_M) $(SCR_OBJECTS_Visu_M)
	...
	$(LINK) '$@.lfl' -o '$@' -p Visu_M -lib '$(LIB_LOCAL_OBJ_Visu_M)' -P '$(AS_PROJECT_PATH)' -m 'local objects' -profile 'False' -warningLevel2 -vcr 4732 -sfas
# 01 Module END
...
$(TEMP_PATH_Visu_M)/Visu_M02.ccf: $(LIB_SHARED) $(SHARED_CCF) $(LIB_BMP_RES_Visu_M) $(TEMP_PATH_Visu_M)/Visu_M03.ccf $(BDR_OBJECTS_Visu_M) $(LFNT_OBJECTS_Visu_M) $(CLM_OBJECTS_Visu_M)
	...
	$(LINK) '$@.lfl' -o '$@' -p Visu_M -lib '$(LIB_LOCAL_RES_Visu_M)' -P '$(AS_PROJECT_PATH)' -m 'local resources' -profile 'False' -warningLevel2 -vcr 4732 -sfas
# 02 Module END
...
$(TEMP_PATH_Visu_M)/Visu_M03.ccf: $(LIB_SHARED) $(SHARED_CCF) $(BMGRP_OBJECTS_Visu_M) $(BMINFO_OBJECTS_Visu_M) $(PALFILE_Visu_M)
	...
	$(LINK) '$@.lfl' -o '$@' -p Visu_M -lib '$(LIB_BMP_RES_Visu_M)' -P '$(AS_PROJECT_PATH)' -m 'bitmap resources' -profile 'False' -warningLevel2 -vcr 4732 -sfas
# 03 Module END

# Post Build Steps

.PHONY : vcPostBuild_Visu_M

vcPostBuild_Visu_M :
	$(VCC) -pb -vcm '$(TEMP_PATH_Visu_M)/MODULEFILES.vcm' -fw '$(VCFIRMWAREPATH)' $(VCCFLAGS_Visu_M) -p Visu_M -vcr 4732 -sfas
