UnmarkedObjectFolder := C:/projects/UnivCntrl/UniversalController/Logical/Universal/LincolnPS
MarkedObjectFolder := C:/projects/UnivCntrl/UniversalController/Logical/Universal/LincolnPS

$(AS_CPU_PATH)/LincolnPS.br: \
	$(AS_PROJECT_CPU_PATH)/Cpu.per \
	$(AS_CPU_PATH)/LincolnPS/LincolnPS.ox
	@"$(AS_BIN_PATH)/BR.AS.TaskBuilder.exe" "$(AS_CPU_PATH)/LincolnPS/LincolnPS.ox" -o "$(AS_CPU_PATH)/LincolnPS.br" -v V1.00.0 -f "$(AS_CPU_PATH)/NT.ofs" -offsetLT "$(AS_BINARIES_PATH)/$(AS_CONFIGURATION)/$(AS_PLC)/LT.ofs" -T SG4  -M IA32  -B E4.26 -extMembers -extNames -extConstants -r Cyclic1 -p 3 -s "Universal.LincolnPS" -L "Acp10man: V3.15.1, Acp10par: V3.15.1, AsARCfg: V*, AsBrMath: V*, AsIecCon: V*, AsIOTime: V*, AsRfbExt: V*, asstring: V*, AsTCP: V*, AsTime: V*, AsUDP: V*, AsXml: V*, bglibas: V*, brsystem: V*, DataObj: V*, dvframe: V*, Ethernet: V*, FileIO: V*, Library: V*, NcGlobal: V3.15.1, Operator: V*, Runtime: V*, sprintf2: V*, standard: V*, sys_lib: V*, Visapi: V*" -P "$(AS_PROJECT_PATH)" -secret "$(AS_PROJECT_PATH)_br.as.taskbuilder.exe"

$(AS_CPU_PATH)/LincolnPS/LincolnPS.ox: \
	$(AS_CPU_PATH)/LincolnPS/a.out
	@"$(AS_BIN_PATH)/BR.AS.Backend.exe" "$(AS_CPU_PATH)/LincolnPS/a.out" -o "$(AS_CPU_PATH)/LincolnPS/LincolnPS.ox" -T SG4 -r Cyclic1   -G V4.1.2  -secret "$(AS_PROJECT_PATH)_br.as.backend.exe"

$(AS_CPU_PATH)/LincolnPS/a.out: \
	$(AS_CPU_PATH)/LincolnPS/LincolnPS.c.o \
...
$(AS_CPU_PATH)/LincolnPS/LincolnPS.c.o: \
	...
	$(AS_PROJECT_PATH)/Logical/Universal/LincolnPS/LincolnPS.c \
	$(AS_PROJECT_PATH)/Logical/Universal/WIREprc/../../Lib/arclink/arclink.h \
	$(AS_PROJECT_PATH)/Logical/Universal/WIREprc/../../Lib/arclink/NetworkAttribute.h \
	$(AS_PROJECT_PATH)/Logical/Universal/WIREprc/../../Lib/arclink/ArcLinkObject.h \
	$(AS_PROJECT_PATH)/Logical/Universal/WIREprc/../../Lib/arclink/Robot.h \
	$(AS_PROJECT_PATH)/Logical/Universal/LincolnPS/../../Lib/arclink/Handler.c \
	$(AS_PROJECT_PATH)/Logical/Universal/LincolnPS/../../Lib/utilityLib/libRingBuffer.h \
	$(AS_PROJECT_PATH)/Logical/Universal/WIREprc/../../Universal/SuperDeclaration.h \
	$(AS_PROJECT_PATH)/Logical/Universal/WIREprc/../../Lib/WSI_types.h \
	$(AS_PROJECT_PATH)/Logical/Libraries/Runtime/runtime.var \
	$(AS_PROJECT_PATH)/Logical/Universal/LincolnPS/../../Lib/libUDP/libUDP.h \
	...
	$(AS_PROJECT_PATH)/Logical/Lib/libUDP/libUDP.h \
	$(AS_PROJECT_PATH)/Logical/Lib/libUDP/libUDP.c \
	...
	$(AS_PROJECT_PATH)/Logical/Lib/arclink/arclink.c \
	$(AS_PROJECT_PATH)/Logical/Lib/utilityLib/libRingBuffer.c \
	$(AS_PROJECT_PATH)/Logical/Lib/arclink/ArcLinkUtility.c \
	$(AS_PROJECT_PATH)/Logical/Lib/arclink/Robot.c \
	$(AS_PROJECT_PATH)/Logical/Lib/arclink/Handler.c \
	...
	@"$(AS_BIN_PATH)/BR.AS.CCompiler.exe" "$(AS_PROJECT_PATH)/Logical/Universal/LincolnPS/LincolnPS.c" -o "$(AS_CPU_PATH)/LincolnPS/LincolnPS.c.o"  -T SG4  -M IA32  -B E4.26 -G V4.1.2  -s "Universal.LincolnPS" -t "$(AS_TEMP_PATH)" -I "$(AS_PROJECT_PATH)/Logical/Universal/LincolnPS" "$(AS_TEMP_PATH)/Includes/Universal/LincolnPS"  "$(AS_TEMP_PATH)/Includes/Universal" "$(AS_TEMP_PATH)/Includes" -trigraphs -fno-asm -D _DEFAULT_INCLUDES -D _SG4 -fPIC -O0 -g -Wall -include "$(AS_CPU_PATH)/Libraries.h" -x c -P "$(AS_PROJECT_PATH)" -secret "$(AS_PROJECT_PATH)_br.as.ccompiler.exe"
