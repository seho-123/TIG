...
# KeyMapping flags
$(TEMP_PATH_Visu1)/dis.PS2-Keyboard.vco: $(AS_PROJECT_PATH)/Physical/X20CP1585_MIG_HW_PS/PLC1/VC/PS2-Keyboard.dis $(PANEL_HW_SOURCE_Visu1)
	$(VCHWPP) -f '$(PANEL_HW_SOURCE_Visu1)' -o '$(subst .vco,.vci,$(TEMP_PATH_Visu1)/dis.PS2-Keyboard.vco)' -n Visu1 -d Visu1 -pal '$(PALFILE_Visu1)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'J4.93' -L 'AsRfbExt: V*, Visapi: V*' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu1) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard '$(AS_PROJECT_PATH)/Physical/X20CP1585_MIG_HW_PS/PLC1/VC/PS2-Keyboard.dis' -fp '$(AS_VC_PATH)/Firmware/V4.73.1/SG4' -prj '$(AS_PROJECT_PATH)' -apj 'UnivCntrl' -sfas -vcob '$(VCOBJECT_Visu1)'
...
KEYMAP_SOURCES_Visu1=$(AS_PROJECT_PATH)/Physical/X20CP1585_MIG_HW_PS/PLC1/VC/PS2-Keyboard.dis 
