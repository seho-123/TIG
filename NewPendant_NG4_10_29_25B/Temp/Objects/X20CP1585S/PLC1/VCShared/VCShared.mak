...
$(AS_CPU_PATH)/VCShared/txtgrp.DWN_UP.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/DWN_UP.txtgrp $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4731 -sfas


$(AS_CPU_PATH)/VCShared/txtgrp.IN_OUT_DWN_UP.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/IN_OUT_DWN_UP.txtgrp $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4731 -sfas


$(AS_CPU_PATH)/VCShared/txtgrp.Indx_Mode.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/Indx_Mode.txtgrp $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4731 -sfas


$(AS_CPU_PATH)/VCShared/txtgrp.Torch_Weld.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/Torch_Weld.txtgrp $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4731 -sfas
