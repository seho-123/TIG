...
FUNCTION_BLOCK CfgGetTimeZone			(*function block returns the ID of the currently active timezone*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
	END_VAR
...
FUNCTION_BLOCK CfgSetTimeZone			(*function block can be used to set the time zone using its ID*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		timezoneID		: UINT;
		option			: UDINT;
...
FUNCTION_BLOCK CfgGetTimeZoneInfo		(*function block returns the time offset between a timezone and GMT during normal time (gmt) and during summer time (gmtDst)*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		timezoneID		: UINT;
	END_VAR
...
FUNCTION_BLOCK CfgGetTimeZoneEntry		(*function block returns the times when the time switches for a particular timezone in a specified year*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		timezoneID		: UINT;
		year			: UINT;
...
FUNCTION_BLOCK CfgGetDst				(*function block returns whether automatic daylight savings time is activated (1) or not (0)*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
	END_VAR
...
FUNCTION_BLOCK CfgSetDst				(*function block can be used to enable or disable automatic daylight savings time*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		dst				: BOOL;
		option			: UDINT;
